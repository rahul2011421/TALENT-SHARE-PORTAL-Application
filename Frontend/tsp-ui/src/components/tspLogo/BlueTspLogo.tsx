...
//image imports 
import logoT from '../../images/TSP_Logo_T.png';
import logoA from '../../images/TSP_Logo_A.png';
import logoL from '../../images/TSP_Logo_L.png';
import logoE from '../../images/TSP_Logo_E.png';
import logoN from '../../images/TSP_Logo_N.png';
import logoPortal from '../../images/TSP_Logo_portal.png';


function BlueTspLogo() {
  return (
    <>

...
import com.maveric.tsp.UserService.client.RegisterService;
import com.maveric.tsp.UserService.config.MasterData;
import com.maveric.tsp.UserService.dtos.*;
import com.maveric.tsp.UserService.entities.UserProfile;
import com.maveric.tsp.UserService.entities.UserProjectExperience;
import com.maveric.tsp.UserService.exception.UserProfileNotFoundException;
import com.maveric.tsp.UserService.mapper.ProfileMapperNew;
import com.maveric.tsp.UserService.mapper.UserProfileMapper;
import com.maveric.tsp.UserService.mapper.UserProjectMapper;
import com.maveric.tsp.UserService.repository.UserProfileRepository;
import com.maveric.tsp.UserService.service.impl.UserProfileServiceImpl;
import com.maveric.tsp.UserService.utils.CommonUtils;
...
//                .thenReturn(ResponseEntity.ok(responseDto));
    ...
    private ArrayList<UserProfile> getUserProfileList(){
        ArrayList<UserProfile> userProfiles=new ArrayList<>();
        UserProfile userProfile1=userProfile;
        userProfile1.setEmailId("rajesh@maveric-systems.com");
        UserProfile userProfile2=userProfile;
        userProfile2.setEmailId("srini@maveric-systems.com");
        userProfile2.setManager(userProfile1);
        UserProfile userProfile3=userProfile;
        userProfile3.setEmailId("praveen@maveric-systems.com");
        userProfile3.setManager(userProfile2);
        UserProfile userProfile4=userProfile;
        userProfile4.setEmailId("vineet@maveric-systems.com");
        UserProfile userProfile6=userProfile;
        userProfile6.setEmailId("daisy@maveric-systems.com");
        UserProfile userProfile5=userProfile;
        userProfile5.setEmailId("prakash@maveric-systems.com");
        userProfiles.add(userProfile);
        userProfiles.add(userProfile1);
